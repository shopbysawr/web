  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!document.getElementById('sidemenu-anim-style')) {
      ...
      animStyle.textContent = [
        ...
        '  user-select: none;',
        '}',
        '.chevron-wrapper:focus { outline: none !important; }',
        '.chevron-wrapper:focus-visible {',
        '  outline: 2px solid var(--primary-500, #0079ff) !important;',
        '  outline-offset: 2px;',
        '}',
    ...
    function addChevronAndToggle(parentSlug) {
      ...
      // A mouse press must never focus the button (that's what caused
      // the brief dark focus ring while pressing). Tab still focuses it.
